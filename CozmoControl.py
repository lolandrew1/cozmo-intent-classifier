...
class CozmoControl(StateMachineProgram):
    ...
    def setup(self):
        ...
        # Code generated by genfsm on Thu Apr 25 15:05:29 2024:
        ...
        say1 = Say("Could you be more clear?") .set_name("say1") .set_parent(self)
        ...
        failuretrans5 .add_sources(execute5) .add_destinations(say1)
        
        completiontrans8 = CompletionTrans() .set_name("completiontrans8")
        completiontrans8 .add_sources(say1) .add_destinations(loop)
